...
class Game:
    def __init__(self):
        ...
        self.picture_one = pygame.image.load("Hard mode/Whisper/c.png")
        self.picture_two = pygame.image.load("Hard mode/Whisper/d.png")
        self.picture_three = pygame.image.load("Hard mode/Whisper/b.png")
        self.picture_four = pygame.image.load("Hard mode/Whisper/a.png")
