...
class Game:
    def __init__(self):
        ...
        self.picture_one = pygame.image.load("Easy mode/Pets/a.jpg")
        self.picture_two = pygame.image.load("Easy mode/Pets/b.jpg")
        self.picture_three = pygame.image.load("Easy mode/Pets/c.jpg")
        self.picture_four = pygame.image.load("Easy mode/Pets/d.jpg")
