...
class Game:
    def __init__(self):
        ...
        self.picture_one = pygame.image.load("Medium mode/Detective/a.png")
        self.picture_two = pygame.image.load("Medium mode/Detective/b.png")
        self.picture_three = pygame.image.load("Medium mode/Detective/c.png")
        self.picture_four = pygame.image.load("Medium mode/Detective/d.png")
