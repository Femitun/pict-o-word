...
class Boxes:
    ...
    for i in range(num_of_white_boxes):
        img = "qaz.jpg"
        box.append(pygame.image.load(img))
            ...
            if rect.collidepoint(mouse_pos) and Boxes.count < len(Boxes.movement_positions) and mouse_pos[1] > 490:
                ...
                if Boxes.count == 9:
                    ...
                    if (Boxes.T1 == Boxes.A1 and Boxes.B6 == Boxes.A2 and Boxes.T4 == Boxes.A3 and
                        ...
                        Boxes.boxX = [466, 510, 554, 598, 642, 686, 730, 774, 466, 510, 554, 598, 642, 686, 730, 774]
                        Boxes.boxY = [520, 520, 520, 520, 520, 520, 520, 520, 564, 564, 564, 564, 564, 564, 564, 564]
                        Boxes.box = []
                        Boxes.num_of_white_boxes = 16

                        for i in range(Boxes.num_of_white_boxes):
                            img = "qaz.jpg"
                            Boxes.box.append(pygame.image.load(img))
