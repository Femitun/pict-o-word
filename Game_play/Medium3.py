...
class Game:
    def __init__(self):
        ...
        self.picture_one = pygame.image.load("Medium mode/Artist/a.jpg")
        self.picture_two = pygame.image.load("Medium mode/Artist/d.jpg")
        self.picture_three = pygame.image.load("Medium mode/Artist/b.jpg")
        self.picture_four = pygame.image.load("Medium mode/Artist/c.jpg")
