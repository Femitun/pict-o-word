...
class Game:
    def __init__(self):
        ...
        self.picture_one = pygame.image.load("Hard mode/Pastry/a.png")
        self.picture_two = pygame.image.load("Hard mode/Pastry/b.png")
        self.picture_three = pygame.image.load("Hard mode/Pastry/c.png")
        self.picture_four = pygame.image.load("Hard mode/Pastry/d.png")
