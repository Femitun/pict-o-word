...
class Game:
    def __init__(self):
        ...
        self.picture_one = pygame.image.load("hard/Pastry/a.png")
        self.picture_two = pygame.image.load("hard/Pastry/b.png")
        self.picture_three = pygame.image.load("hard/Pastry/c.png")
        self.picture_four = pygame.image.load("hard/Pastry/d.png")
